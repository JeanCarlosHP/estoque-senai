...
public class Routes extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("direct:cadastrarProduto")
				...
				.to("sql:INSERT INTO Produtos (nome_produto, descricao_produto, quantidade_produto, valor_produto) VALUES (:#nome, :#descricao, :#quantidade, :#valor)?parametersCount=4")
